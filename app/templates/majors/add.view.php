    ...
    <div class="container mt-20 container-form">
        ...
        <form class="row g-3" method="POST" >
            ...
            <div class="col-md-6 input" required>
                ...
                <input type="text" class="form-control" id="MajorName" name="MajorName"  value="<?= $controller->getStorePost("MajorName") ?>" required>
            ...
            <div class="col-md-6 input" required>
                ...
                <input type="number" class="form-control" id="CoursesNumber" between="40,85" name="CoursesNumber" value="<?= $controller->getStorePost("CoursesNumber") ?>" required>
                <div class="valid-feedback">
                    <?= $valid_feedback ?>
                </div>
                <div class="invalid-feedback">
                ...
                <select class="form-select" id="MajorDepartmentID" name="MajorDepartmentID" required>
                    ...
                    <?php
                        foreach ($departments as $department) {
                            ...
                            ?>
                                <option <?= $controller::setSelectedAttribute($department->DepartmentID, $controller->getStorePost("MajorDepartmentID") ) ?>
            ...
            <div class="col-12">
                <button class="main-btn" name="add" type="submit"><?= $add_major ?></button>
            </div>
        </form>
    </div>
</main>
